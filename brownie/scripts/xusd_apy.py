...
def main():
	...
	xusd_pool = Contract.from_explorer("0x87650D7bbfC3A9F10587d7778206671719d9910D")
	xusd_gauge = Contract.from_explorer("0x25f0cE4E2F8dbA112D9b115710AC297F816087CD")

	ogn_reward_token = xusd_gauge.reward_tokens(0)
	tokens_received = xusd_gauge.reward_data(ogn_reward_token).dict()["rate"] * 31536000 # seconds in a year

	total_supply = xusd_gauge.totalSupply()
	...
	weight = gauge_controller.gauge_relative_weight(xusd_gauge)
	inflation = xusd_gauge.inflation_rate()
	workingSupply = xusd_gauge.working_supply()
	# virtualPrice = pool_info_getter.get_virtual_price_from_lp_token(xusd_pool)
